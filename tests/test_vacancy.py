...
def test_salary_validation_empty():
...
def test_salary_validation_partial():
...
def test_vacancy_slots():
    ...
    expected_slots = {
        'name', 'url', 'salary', 'description',
        'schedule', 'experience', 'salary_from', 'salary_to'
    }
    assert set(Vacancy.__slots__) == expected_slots

def test_invalid_vacancy_creation():
